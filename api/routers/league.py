...
@router.get("/teams")
def get_teams():
    return query_roster.query_roster(view="teams")


@router.get("/roster")
def get_roster(team: str | None = None):
    return query_roster.query_roster(view="roster", team=team)


@router.get("/matchups")
def get_matchups(week: int | None = None, team: str | None = None):
    return query_roster.query_roster(view="matchup", team=team, week=week)
